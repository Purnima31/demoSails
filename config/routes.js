...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'GET /articles': {controller:'ArticlesController',action:'list'},
  'POST /articles/add': {controller:'ArticlesController',action:'add'},
  'GET /articles/edit/:id': {controller:'ArticlesController',action:'edit'},
  'GET /articles/delete/:id': {controller:'ArticlesController',action:'delete'},
